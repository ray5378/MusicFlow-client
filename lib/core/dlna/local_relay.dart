...
///
/// 投屏采用「中继」模式：客户端把每首歌从服务端拉成**有限大小、带 Content-Length**
/// 的单曲流，再经本中继 URL 交给 DLNA 设备。设备按普通单曲流播放，对非 mp3 之外的
/// 采样率/声道突变、长 URL、无 Content-Length 的连续流等兼容性最好（d6d5b1a 恢复）。
class LocalRelay {
  HttpServer? _server;
